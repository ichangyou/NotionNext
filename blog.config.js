...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 7200, 
  ...
  // 相比 1800 秒，爬虫写入量直接砍掉 50%-75%；相比86400，发布延迟可以接受。对一个博客来说，发完文章 1 小时内上线完全合理。
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mufeng.blog', // 网站地址
  ...
  CUSTOM_EXTERNAL_CSS: ['/styles/enhanced_mufeng.css'], // e.g. ['http://xx.com/style.css','http://xx.com/style.css']
